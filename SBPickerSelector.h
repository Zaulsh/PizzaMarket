...
-(void) pickerSelector:(SBPickerSelector *)selector selectedValues:(NSArray *)values atIndexes:(NSArray *)idxs;
...
-(void) pickerSelector:(SBPickerSelector *)selector intermediatelySelectedValues:(NSArray *)values atIndexes:(NSArray *)idxs;
